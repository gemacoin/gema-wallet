...
String? transactionAmmountValidator(String? value) {
  ...
  if (double.parse(value) <= 0) {
    return 'You must send at least 0.000000001 GEMA';
  } else {
    return null;
  }
}
            ...
            onPressed: () async {
              ...
              if (addressIsOk && balanceIsOk) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                        'Sending $sendAmmount GEMA to ${destination.substring(0, 5)}...'),
                  ),
                );
